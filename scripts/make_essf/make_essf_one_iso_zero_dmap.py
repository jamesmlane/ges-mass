# ----------------------------------------------------------------------------
#
# TITLE - make_essf_one_iso_zero_dmap.py
# AUTHOR - James Lane 
# PROJECT - ges-mass
# CONTENTS:
#
...
isochrone drawn from a larger grid of isochrones. Use mwdust.Zero for no
extinction
'''
...
print('Loading Zero dust map from mwdust')
...
apogee_effSF_filename = data_dir+gaia_apogee_dir+\
    'apogee_effSF_grid_inclArea_z'+str(Zini)+'_logAge'+str(logAge)+'_dmap_Zero.dat'
